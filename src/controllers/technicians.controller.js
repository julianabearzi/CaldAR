...
const updateTechnician = async (req, res) => {
    try {
        const technicianUpdated = await TechnicianSchema.findOneAndUpdate({ _id: req.params.id }, req.body, { new: true });
...
const deleteTechnician = async (req, res) => {
    try {
        const technicianFound = await TechnicianSchema.findOneAndRemove({ _id: req.params.id });

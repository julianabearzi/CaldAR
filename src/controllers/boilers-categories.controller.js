...
const getBoilerCategoryByDescription = async (req, res) => {
    try {
        const response = await BoilerCategorySchema.findOne({ description: req.query.description });
...
const updateBoilerCategory = async (req, res) => {
    try {
        const BoilerCategoryUpdated = await BoilerCategorySchema.findOneAndUpdate({ _id: req.params.id }, req.body, { new: true });
...
const deleteBoilerCategory = async (req, res) => {
    try {
        const BoilerCategoryFound = await BoilerCategorySchema.findOneAndRemove({ _id: req.params.id });
